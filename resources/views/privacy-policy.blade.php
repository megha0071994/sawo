...
@section('content')
<div class="breadcrum">
        <h1>   Privacy Policy<span class="color">  Sawo</span></h1>
    </div>
<div id="about-main" class=" pb-100">
        ...
        <div class="container about-page pb-100 pt-100">
            <div class="row py-2">
                ...
                <p>No use of <b class="text-info">Sawo Services's</b> logo or other artwork will be allowed for linking absent a trademark
                    license agreement.</p>
