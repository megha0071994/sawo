...
@section('content')
<div class="breadcrum">
        <h1>   Terms and Conditions <span class="color">  Sawo</span></h1>
    </div>
<div id="about-main" class=" pb-100">
        ...
        <div class="container about-page pb-100 pt-100">
            <div class="row py-2">
                ...
                <h4 class="text-info"><b>Welcome to Sawo!</b></h4>
                <p>These terms and conditions outline the rules and regulations for the use of <b class="text-info">Sawo
                        Services's</b> Website, located at <b class="text-info">www.sawo.in</b> </p>
                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                    Sawo if you do not agree to take all of the terms and conditions stated on this page.</p>
                <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                    ...
                    with and subject to, prevailing law of INDIA. Any use of the above terminology or other words in the
                    singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore
                    as referring to same.</p>
                <h4 class="text-info"><b>Cookies</b></h4>
                <p>We employ the use of cookies. By accessing Sawo, you agreed to use cookies in agreement with the Sawo
                    Services's Privacy Policy.</p>
                ...
                <h4 class="text-info"><b>License</b></h4>
                <p>Unless otherwise stated, <b class="text-info">Sawo Services's</b> and/or its licensors own the intellectual property
                    rights for all material on Sawo. All intellectual property rights are reserved. You may access this
                    from Sawo for your own personal use subjected to restrictions set in these terms and conditions.</p>
                <p><b>You must not:</b></p>
                <ol>
                    <li>Republish Activities from Sawo</li>
                    <li>booking, rent or sub-license material from Sawo</li>
                    <li>Reproduce, duplicate or copy material from Sawo</li>
                    <li>Redistribute content from Sawo</li>
                </ol>
                <h4 class="text-info"><b>This Agreement shall begin on the date hereof.</b></h4>
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                    information in certain areas of the website and application. <b class="text-info">Sawo Services's</b> does not filter, edit,
                    publish or review Comments prior to their presence on the website and application. Comments do not
                    reflect the views and opinions of <b class="text-info">Sawo Services's</b>,its agents and/or affiliates. Comments reflect the
                    views and opinions of the person who post their views and opinions. To the extent permitted by
                    applicable laws, <b class="text-info">Sawo Services's</b> shall not be liable for the Comments or for any liability, damages or
                    expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
                    Comments on this website.
                </p>
                <p><b class="text-info">Sawo Services's</b> reserves the right to monitor all Comments and to remove any Comments which can
                ...
                <p>You hereby grant <b class="text-info">Sawo Services's</b> a non-exclusive license to use, reproduce, edit and
                    authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or
                    media.
                </p>
                <h4 class="text-info"><b>Hyperlinking to our Content</b></h4>
                <b>The following organizations may link to our Website without prior written approval:</b>
                <ol>
                ...
                <p>These organizations may link to our home page, to publications or to other Website
                    information so long as the link: <br>(a) is not in any way deceptive; <br>(b) does not falsely imply
                    sponsorship, endorsement or approval of the linking party and its products and/or services; and
                    <br>(c) fits within the context of the linking party’s site.</p>
                <b>We may consider and approve other link requests from the following types of
                    organizations:</b>
                <ol>
                    <li>commonly-known consumer and/or business information sources;</li>
                    <li>dot.in community sites;</li>
                ...
                <p>We will approve link requests from these organizations if we decide that: <br>(a) the
                    link would not make us
                    look unfavorably to ourselves or to our accredited businesses; <br>(b) the organization does
                    not have any negative records with us;<br> (c) the benefit to us from the visibility of the
                    hyperlink compensates the absence of <b class="text-info">Sawo Services's</b>; and <br>(d) the link is in the context of
                    general resource information.</p>
                <p>These organizations may link to our home page so long as the link:<br> (a) is not in
                    any way deceptive; <br>(b) does not falsely imply sponsorship, endorsement or approval of the
                    linking party and its products or services; and <br>(c) fits within the context of the linking
                    party’s site.</p>
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in
                    linking to our website, you must inform us by sending an e-mail to <b class="text-info">Sawo Services's</b>. Please include
                    your name, your organization name, contact information as well as the URL of your site, a list of
                    any URLs from which you intend to link to our Website, and a list of the URLs on our site to which
                    you would like to link. Wait 2-3 weeks for a response.</p>
                <h4 class="text-info"><b>Approved organizations may hyperlink to our Website as
                        follows:</b></h4>
                <ol>
                ...
                <p>No use of <b class="text-info">Sawo Services's</b>'s logo or other artwork will be allowed for linking absent a trademark
                    license agreement.</p>
                <h4 class="text-info"><b>iFrames</b></h4>
                ...
                <h4 class="text-info"><b>Content Liability</b></h4>
                <p>We shall not be hold responsible for any content that appears on your Website. You agree
                    ...
                    otherwise violates, or advocates the infringement or other violation of, any third party rights.</p>
                <h4 class="text-info"><b>Your Privacy</b></h4>
                <b>Please read Privacy Policy</b>
                        <h4 class="text-info"><b>Reservation of Rights</b></h4>
                        <p>We reserve the right to request that you remove all links or any particular link to our
                            ...
                            and conditions.</p>
                        <h4 class="text-info"><b>Removal of links from our website</b></h4>
                        ...
                        <h4 class="text-info"><b>Disclaimer</b></h4>
                        ...
                        <h4 class="text-info"><b>Terms and condition for driver </b></h4>
                        <p>Sawo offer earning portal and application for all drivers. but there some need to terms and
                            condtion by sawo organization . </p>
                        <p>Driver should have complete documents including driving license , insurance, RTO documents ,
                            Medical Documents , RC , all type certification for Cab, Auto, and Machines which one want
                            to add with sawo application and organization .</p>
                        <p>All payments, will be distributed via sawo company banking system and option. </p>
                        <h4 class="text-info"><b>Terms and condition for vendor </b></h4>
                        <p> Sawo offer cab. Auto and machine attachment service by sawo vendor application . there will
                            be provide randomly provide business opportunity all all vendor according own local area and
                            service covered area . there all type documents should be compulsory for attached Auto,
                            Cars, Truck and machines </p>
                </div>        
            </div>
        </div>
    </div>
